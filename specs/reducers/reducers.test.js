...
import { initialState, rootReducer, flagsReducer, specializedReducer } from '../../src/reducers';
...
describe('specializedReducer', () => {
  ...
  it('should set the data for an individual currency when passed the receiveSpecializedData action', () => {
    const testAction = {
